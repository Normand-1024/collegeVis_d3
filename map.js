...
function createMap() {
    ...
    var projection = d3.geo.albersUsa()
                    .translate([width/2 + 70, height/2 + 40])    // translate to center of screen
    ...
    d3.csv("./misc/stateslived.csv", function(data) {
    ...
    svg.selectAll("circle")
        ...
        .on("mouseover", function(d) { 
            ...
            .duration(200)      
            .style("opacity", .8);  
            div.text(d.institution + " " + d.city + ", " + d.state + " " + d.website)
            // .attr("data-html", "true")
